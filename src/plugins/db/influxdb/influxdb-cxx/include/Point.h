...
class Point
{
  public:
    ...
    /// Adds filed
    Point&& addField(std::string_view name, std::variant<short, unsigned short, int, unsigned int, long int, unsigned long int, long long int, std::string, double> value);
